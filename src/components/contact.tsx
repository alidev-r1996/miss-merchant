...
const Contact = () => {
  ...
  return (
    <>
      ...
      >
        <div onClick={() => setSocial(prev => ({ ...prev, wechat: !prev.wechat }))} className={`${social.wechat && "bg-green-500 text-white"} flex items-center rounded shadow group px-4 whitespace-nowrap transition-all duration-300 hover:bg-green-500 hover:text-white active:bg-green-500 active:text-white focus:bg-green-500 focus:text-white cursor-pointer`}>
        ...
        <div onClick={() => setSocial(prev => ({ ...prev, email: !prev.email }))} className={`${social.email && "bg-rose-500 text-white"} flex items-center rounded shadow group px-4 whitespace-nowrap transition-all duration-300 hover:bg-rose-500 hover:text-white active:bg-rose-500 active:text-white focus:bg-rose-500 focus:text-white cursor-pointer`}>
